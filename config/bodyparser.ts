...
const bodyParserConfig: BodyParserConfig = {
  ...
  */
  ...
  |--------------------------------------------------------------------------
  |
  | The settings for the JSON parser. The enumtypes defines the request content
  | enumtypes which gets processed by the JSON parser.
  |
  */
  json: {
    encoding: 'utf-8',
  ...
  |--------------------------------------------------------------------------
  |
  | The settings for the `application/x-www-form-urlencoded` parser. The enumtypes
  | defines the request content enumtypes which gets processed by the form parser.
  |
  */
  form: {
    encoding: 'utf-8',
  ...
  */
  ...
  |--------------------------------------------------------------------------
  |
  | The settings for the `multipart/form-data` parser. The enumtypes defines the
  | request content enumtypes which gets processed by the form parser.
  |
  */
  multipart: {
    /*
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The enumtypes that will be considered and parsed as multipart body.
    |
    */
